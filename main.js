function langToCurr(locale) {
	if (typeof locale !== "string") throw new TypeError("jnltc wants a string")

	const code = currencyNames.find(item => item.locale === locale)
...
module.exports = {langToCurr, currencyNames}